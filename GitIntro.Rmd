...
GitHub is the online database that stores the versions of your software. Its pretty user friendly. You can edit, comment, and see the history of each document online. 

Git is the program downloaded onto your comupter. It looks like a terminal/command line type of deal that has its own language and commands to use. We can primarily just use it to link GitHub and RStudio.If you learn the langauge, you can do your own coding and program editing in Git, but its not necessary for useage with RStudio. There are also third-party platforms, like SourceTree, to use which might make using just Git easier.   
...
Push - when you have commited your changes and want to save the edits back in the repository 
...
This is a beginning GitHub exercise. I recomend reading it because it also defines some of the langauge, although the exercise is only somewhat helpful. 
...
2. Download Git- (Chapter 7 in book). Make sure to save it in someplace easily accessible because Windows will want to save it in a place thats hard to find. https://gitforwindows.org/ 
3. Open Git Bash and Introduce Yourself (Chapter 8)
4. Connect your Git and GitHub accounts (Chapter 10)
...
After that you should be all set up. If something went wrong, you can google the errors and its usually pretty helpful. Any time you wan tot make a new repository or project, you can follow the video above. 
